...
export default function AboutSection() {
  ...
  const isInView = useInView(astroContainerRef, {
    once: true,
    amount: 0.5,
  });
        ...
        >
          ...
          >
            <motion.div variants={globalVariant}>
              <Lottie animationData={astroAnimation} loop={true}></Lottie>
            </motion.div>
          ...
          <div className="relative h-full w-full grid lg:grid-cols-3 items-center justify-center max-w-[90%] mx-auto px-12">
            <div className="lg:col-span-2 py-8">
              ...
              <p className="lg:text-3xl xl:text-4xl text-lg max-sm:text-center sm:text-2xl font-semibold">
                Creating seamless digital experiences drives me. I thrive on
                transforming ideas into functional, beautiful designs with a
                focus on clean code and innovation
              </p>
            </div>
            <Lottie animationData={developerThinking} loop={true}></Lottie>
          </div>
        </motion.div>
          ...
          <MaxWidthWrapper className="flex-1 flex flex-col">
            ...
            >
              ...
              >
                <SkillCard
                  title="React Js"
                  description="Front-End solution"
                  icon="react"
                />
              </motion.div>
              <motion.div
